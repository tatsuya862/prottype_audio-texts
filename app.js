const episodes = [
  {
    id: "quitting-power",
    title: "やめられない人が失っている潜在的損失",
    series: "Action Strategy",
    tag: "やめる力",
    duration: "音声 5分 / 読了 7分",
    audio: "assets/audio/quitting-power-summary.wav",
    lead: "成果が出ない行動をやめ、時間・集中力・資金を再配分する。戦略的Pivotを実例で整理する。",
    body: [
      ["この話のコア", "やめることは逃げではない。戦略的にやめられない人ほど、時間、体力、集中力、信用、資金を失う。人生を好転させるには、何を始めるかだけでなく、何をやめるかを決める必要がある。"],
      ["潜在的損失", "挑戦しない人は、何もしていないのではなく、古い選択を続けている。不満な働き方、変わらない人間関係、成果につながらない勉強、感情を消耗するSNS、収益につながらない作業。これらを続けるほど、次の挑戦に使う余力が減っていく。"],
      ["自然界とミツバチ", "自然界では、生き残るためにやめることが普通に起きている。ミツバチは一度刺すと死ぬため、防衛行動にも命という大きなコストがある。生き物は、リスクとリターンのバランスを比較して行動している。"],
      ["トレードへの接続", "トレーダーは、期待値がリスクを上回る場合のみ資金をリスクにさらす。期待値がないならエントリーしないことが合理的。ビジネスや人生でも同じで、期待値が低い行動を続けるほど未来の自由度を削る。"],
      ["成功が損失になる瞬間", "収入はあるが消耗が大きい仕事、評価はされるが成長しない仕事、安定しているが自由度が低い仕事は、一見成功に見える。しかし、自分の未来につながらないなら、依存し続けることで自由、学習時間、健康、創造性を失う。"],
      ["実例", "肺気胸になった経験から、たばこをやめた。健康リスクが自分の身体に直結したことで、やめる判断ができた。また、2022年頃の就職難で死を意識し、短期志向の転職と就職をやめる決断をした。短期不安を埋める選択と、長期の自由度を上げる選択は分ける必要がある。"],
      ["戦略的Pivot", "戦略的Pivotのメリットは、成果が出ないことをやめてリソースを再配分できること。成果が出ない方法、未来につながらない作業、認知資源を奪う習慣、リスクだけ大きく期待値が低い行動をやめることで、時間、集中力、体力、資金、信用、検証回数を取り戻せる。"],
      ["判断基準", "やめるか続けるかは感情で決めない。長期目標に接続しているか、スキルが残るか、比較優位が出ているか、リスクが大きすぎないか、2か月以内に小さな成果が見えるか。この5つで判断する。"],
      ["今日の行動", "今続けているが未来につながっていない行動を1つ書き出し、1週間だけ戦略的にやめる。時間が増えたか、気分が軽くなったか、新しい行動に使えたか、成果や反応が良くなったかを確認する。"],
      ["まとめ", "やめることは、挑戦するための空白を作ること。人生を変えるのは始める力だけではない。やめる力も必要になる。"]
    ]
  },
  {
...
async function saveForOffline() {
  ...
  const cache = await caches.open("quant-log-drive-study-v13");
  const urls = [
    "./",
    "index.html",
    "styles.css",
    ...
    "assets/audio/quitting-power-summary.wav",
